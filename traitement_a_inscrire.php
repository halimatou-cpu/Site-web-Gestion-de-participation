<?php
	$page_title = "Traitement à inscrire";
	include("session.php");
	$eid = $_POST['eid'];
	...
	if($res['COUNT(*)']<1)
	{
		...
		echo "<meta http-equiv='refresh' content='2;liste_event_fermes_inscription.php' />";
	}
	else
	{
		if(!isset($_POST['pid']))
		{
	   		...
	   		echo "<meta http-equiv='refresh' content='0;liste_a_inscrire.php?eid=".$eid."' />";
		}
		else
		{
